...
class Publication(TypedDict, total=False):
    antibodies: Iterable[PublicationAntibody]
    """A list of antibodies used in the assay that created the dataset"""
...
class PublicationAntibody(TypedDict, total=False):
    antibody_name: str
    """The name of the antibody."""
...
class Epicollection(TypedDict, total=False):
    contacts: Iterable[PersonParam]
    """
    A list of the people who are the main contacts to get information about the
    entity.
...
EntityUpdateParams: TypeAlias = Union[Donor, Sample, Dataset, Upload, Publication, Collection, Epicollection]
