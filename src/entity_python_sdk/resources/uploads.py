...
from ..types.upload_param import UploadParam
...
class UploadsResource(SyncAPIResource):
    ...
    def update_bulk(
        ...
        *,
        ...
        return self._put(
            "/uploads",
            body=maybe_transform(body, Iterable[UploadParam]),
    ...
    async def update_bulk(
        ...
        *,
        ...
        return await self._put(
            "/uploads",
            body=await async_maybe_transform(body, Iterable[UploadParam]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=UploadUpdateBulkResponse,
