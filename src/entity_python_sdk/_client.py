...
from .resources import doi, samples, uploads, children, ancestors, descendants, entity_types
...
class EntityPythonSDK(SyncAPIClient):
    ...
    with_raw_response: EntityPythonSDKWithRawResponse
    with_streaming_response: EntityPythonSDKWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        if base_url is None:
            base_url = os.environ.get("ENTITY_PYTHON_SDK_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = EntityPythonSDKWithRawResponse(self)
        self.with_streaming_response = EntityPythonSDKWithStreamedResponse(self)
...
class AsyncEntityPythonSDK(AsyncAPIClient):
    ...
    with_raw_response: AsyncEntityPythonSDKWithRawResponse
    with_streaming_response: AsyncEntityPythonSDKWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = AsyncEntityPythonSDKWithRawResponse(self)
        self.with_streaming_response = AsyncEntityPythonSDKWithStreamedResponse(self)
...
AsyncClient = AsyncEntityPythonSDK
