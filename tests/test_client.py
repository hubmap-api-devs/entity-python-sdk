...
from entity_python_sdk import EntityPythonSDK, AsyncEntityPythonSDK, APIResponseValidationError
from entity_python_sdk._types import Omit
from entity_python_sdk._models import BaseModel, FinalRequestOptions
from entity_python_sdk._constants import RAW_RESPONSE_HEADER
from entity_python_sdk._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from entity_python_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EntityPythonSDK | AsyncEntityPythonSDK) -> int:
...
class TestEntityPythonSDK:
    client = EntityPythonSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "entity_python_sdk/_legacy_response.py",
                        "entity_python_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "entity_python_sdk/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: EntityPythonSDK) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENTITY_PYTHON_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = EntityPythonSDK(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EntityPythonSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = EntityPythonSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("entity_python_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: EntityPythonSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncEntityPythonSDK:
    client = AsyncEntityPythonSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEntityPythonSDK) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENTITY_PYTHON_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEntityPythonSDK(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEntityPythonSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEntityPythonSDK(
        ...
        client = AsyncEntityPythonSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncEntityPythonSDK,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncEntityPythonSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from entity_python_sdk._utils import asyncify
        from entity_python_sdk._base_client import get_platform 
